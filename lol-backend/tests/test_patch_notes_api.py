...
def test_get_latest_patch_note_returns_service_payload(monkeypatch):
    ...
    async def fake_upsert_latest(payload):
        return fake_saved

    fake_repo.upsert_latest = fake_upsert_latest
    ...
    app.dependency_overrides[patch_notes.get_patch_notes_repository] = lambda: fake_repo

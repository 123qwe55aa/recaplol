    ...
    <>
      <section className="rounded-lg border border-gray-800 bg-gray-900 p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="inline-flex shrink-0 items-center justify-center rounded-lg bg-yellow-500 px-5 py-3 font-bold text-black transition-colors hover:bg-yellow-400"
          >
            问 AI Coach
          </button>
        </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
          <section className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-lg border border-gray-700 bg-gray-900 p-5 shadow-2xl">
